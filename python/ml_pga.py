...
class PgaSimulator(object):
    ...
    def simulate(self, verbose=False, tracking=False):
        ...
        '''
        if tracking:
            mlflow_server = 'postgresql://postgres:MC2jW8dBNTkC028ElJ0Uflvt@ml-flow-postgresql.cxmbk6ooy1lu.us-east-1.rds.amazonaws.com/mlflow' # set to your server URI
            mlflow.set_tracking_uri(mlflow_server)
            mlflow.set_experiment("/mnt/efs/experiments/pga2020")

            client = MlflowClient()
            experiments = client.list_experiments() # returns a list of mlflow.entities.Experiment
            run = client.create_run(experiments[0].experiment_id) # return mlflow.entities.Run
